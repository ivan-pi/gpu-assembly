...
/*
 * The box is the library's rbf::spatial::PeriodicBox<T, 2>: [0, Lx) x
 * [0, Ly) with periodic images, period = {Lx, Ly}. The mode (nx, ny)
 * has the wave number (2 pi nx/Lx, 2 pi ny/Ly); in lattice units
 * Lx = nx cells.
 */
