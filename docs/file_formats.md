...
and EDU2D solver codes. The format is described in:
...
- Nishikawa, Hiroaki. (2019). [Making Your Own Mesh: A List of Custom
  Grid Generation
  ...
  Joint NIA & SU2 Foundation user workshop.

We implement the layout of the second talk:
